...
- [Set up `uv` to manage python versions and package installations](#set-up-uv-to-manage-python-versions-and-package-installations)
  ...
  - [(optional) Install desired python versions with](#optional-install-desired-python-versions-with)
...
- [Set up Noxfile.py](#set-up-noxfilepy)
  ...
  - [Use uv to handle package installations](#use-uv-to-handle-package-installations)
  - [Poetry installation (no longer preferred)](#poetry-installation-no-longer-preferred)
- [Using Nox to compare pip, poetry, and uv](#using-nox-to-compare-pip-poetry-and-uv)
