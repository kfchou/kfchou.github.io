---
layout: post
title:  Setting up Python dev tools in linux
...
If you used uv to install nox, you may need to manually install uv-managed python prior to running nox with uv as the backend, e.g.,
```bash
uv install python 3.x
```
...
todo:
* [Type checkers](https://pydevtools.com/blog/analysis-of-the-new-wave-of-python-type-checkers/)
* [prek](https://pydevtools.com/blog/prek-pre-commit-but-fast/)
