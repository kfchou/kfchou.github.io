...
- [Installation](#installation)
  - [Install a specifiv version of uv](#install-a-specifiv-version-of-uv)
...
- [System-wide tool management](#system-wide-tool-management)
  - [Tools with plugins](#tools-with-plugins)
  - [Tools with python dependencies](#tools-with-python-dependencies)
- [Security Audit](#security-audit)
- [Quirks and Common Issues](#quirks-and-common-issues)
  - [Package Installation with `uv sync`](#package-installation-with-uv-sync)
    - [How do I upgrade my subdependencies?](#how-do-i-upgrade-my-subdependencies)
    - [I want to use a different virtual environment, one that's already active.](#i-want-to-use-a-different-virtual-environment-one-thats-already-active)
  - [Migrating from a different package manager](#migrating-from-a-different-package-manager)
...
## Tools with plugins
Some tools, like Poetry, has plugins that you can install via
```
...
The syntax in uv is
```
uv tool install poetry --with <plugin>
```
...
uv tool install poetry --with poetry-auto-export
```
...
# Security Audit
uv replaces `pip-audit`

To scan for known CVEs in your dependencies, just run in your console:
```sh
uv audit
```

Available with versions 0.8.x or newer. [docs](https://docs.astral.sh/uv/reference/cli/#uv-audit)
