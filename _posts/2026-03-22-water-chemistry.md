...
* Third Wave Water (TWW) classic and espresso profiles achieves a relatively hard profile
...
* Calcium helps extract heavy oils and tactile components
...
Milk is slightly acidic, but it is a powerful buffer. The proteins act as chemical "sponges" that can absorb hydrogen ions from the coffee's acids. Additionally, the phosphate ions in milk are classic buffering agents in chemistry. Adding an espresso (pH ~4.5) into milk will neutralize the flavorful aromatic compounds.
...
Next, determine your target range of GH and KH values.  I'm aiming for GH 80ppm and KH 50ppm
